-- Add certifications column to user_profiles_public
ALTER TABLE user_profiles_public ADD COLUMN IF NOT EXISTS certifications jsonb;

-- Update the sync trigger to include certifications
