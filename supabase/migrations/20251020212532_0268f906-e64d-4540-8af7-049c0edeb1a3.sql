...
-- Drop tables if they exist (clean slate for certification system)
DROP TABLE IF EXISTS public.cert_certifications CASCADE;
DROP TABLE IF EXISTS public.cert_results CASCADE;
DROP TABLE IF EXISTS public.cert_answers CASCADE;
DROP TABLE IF EXISTS public.cert_sessions CASCADE;
DROP TABLE IF EXISTS public.cert_questions CASCADE;
...
DROP FUNCTION IF EXISTS generate_cert_verification_code();
