...
export default function MentorDashboard() {
  ...
  const { data: subscription, isLoading: subLoading } = useMentorSubscription();
  ...
  return (
    <>
      {showLoader && <LansaLoader duration={5000} onComplete={() => setShowLoader(false)} />}

      <SEOHead
        title="Mentor Dashboard | Lansa"
        description="Manage your mentor profile, videos, and subscription on Lansa."
      />
