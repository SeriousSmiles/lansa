import { Home, Users, Building2, DollarSign, TrendingUp, BarChart3, Clock, FileText, HelpCircle, Settings, Search, Megaphone, Video, GraduationCap } from 'lucide-react';
...
const menuItems = [
  ...
  { title: 'Content', url: '/admin/content', icon: Video },
