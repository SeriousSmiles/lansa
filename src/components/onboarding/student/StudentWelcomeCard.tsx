        ...
        <div className="text-center space-y-6">
          ...
          <div className="pt-6">
            <Button 
              onClick={onStart}
              size="lg"
              className="px-12 py-4 text-base md:text-sm bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-primary-foreground shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
            >
