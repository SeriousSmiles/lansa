...
export const templateRegistry: TemplateConfig[] = [
  ...
  },
  {
    ...
    engine: 'react-pdf',
    supportsATS: true,
    component: () => import('./templates/pdf/ModernDoc'),
    icon: Palette,
  ...
  },
  {
    ...
    engine: 'react-pdf',
    supportsATS: false,
    component: () => import('./templates/pdf/CreativeDoc'),
    icon: Sparkles,
  ...
  },
  {
    ...
    engine: 'react-pdf',
    supportsATS: true,
    component: () => import('./templates/pdf/ClassicDoc'),
    icon: FileText,
  ...
  },
  {
    ...
    engine: 'react-pdf',
    supportsATS: false,
    component: () => import('./templates/pdf/TimelineDoc'),
    icon: Clock,
  ...
  },
  {
    ...
    engine: 'react-pdf',
    supportsATS: true,
    component: () => import('./templates/pdf/LogosDoc'),
    icon: Building2,
